...
public class FielderIK : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        m_RightHandEffector.transform.SetParent(effectorParent);
        m_LeftKneeHintEffector.transform.SetParent(effectorParent);
        m_RightKneeHintEffector.transform.SetParent(effectorParent);
